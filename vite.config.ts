  ...
  plugins: [
    ...
    federation({
      ...
      exposes: {
        ...
        './WorkflowStatusPanel': './src/components/slots/WorkflowStatusPanel.tsx',
        './ExecutionMonitor': './src/components/slots/ExecutionMonitor.tsx',
        './IntegrationStatus': './src/components/slots/IntegrationStatus.tsx',
      },
      shared: {
        'react': {
          singleton: true,
